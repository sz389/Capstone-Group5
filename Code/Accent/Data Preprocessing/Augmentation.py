...
if __name__ == "__main__":
    ...
    parser.add_argument("--csv_name", default=None, type=str, required=True)  # Path to save the csv file
...
#%%
    df = pd.read_csv(folder + csv_file) # accent_train_trim_split.csv
    # df['id'] = folder + 'trimed_audio/' + df['wav_name']
    df['id'] =  df['path']
    df['label'] = df['native_language']
#%%
    train_set_path = df
