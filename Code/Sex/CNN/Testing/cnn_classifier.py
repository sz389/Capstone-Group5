...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_csv", default=f"cnn_train.csv", type=str, required=False)  # train_csv
    parser.add_argument("--val_csv", default=f"cnn_val.csv", type=str, required=False)  # val_csv
    parser.add_argument("--test_csv", default=f"cnn_test.csv", type=str, required=False)  # test_csv
