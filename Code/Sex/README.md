...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Sex/Data%20Processing/data_preprocessing.py" target="_blank">Data Preprocessing</a>
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Sex/Data%20Processing/generate_mel_spectrogram.py" target="_blank">Generating Mel Spectrograms</a>
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Sex/CNN/Training/train_cnn.py" target="_blank">Training CNN</a>
...
```
python3 train_cnn.py --csv_load_path "/Sex/Data/"                    
                     --category "sex"               
                     --train_csv "sex_train.csv"          
                     --val_csv "sex_val.csv"
                     --test_csv "sex_test.csv"
                     --epochs 30
                     --batch_size 64
                     --learning_rate 1e-3
                     --model "resnet18"
                     --model_save_path "/Sex/CNN/Models/Saved_Models/"
```
- _csv_load_path_: folder path to load the train, validation and test csv files
- _category_: either "sex", "age", "race", "emotion"
- _train_csv_: the train csv file (default = sex_train.csv)
- _val_csv_: the validation csv file (default = sex_val.csv)
- _test_csv_: the test csv file (default = sex_test.csv)
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Sex/Data%20Processing/augmentation.py" target="_blank">Augmenting Audio</a>
...
```
python3 augmentation.py --csv_folder "/Sex/Data/"                    
                        --save_path "/Sex/Data/"               
                        --category "sex"      
```
- _csv_folder_: path to to load in the train data (sex_train.csv)
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Sex/CNN/Training/train_autoencoder.py" target="_blank">Training AutoEncoder</a>
...
```
python3 train_autoencoder.py --csv_load_path "/Sex/Data/"                    
                             --category "sex"               
                             --train_csv "sex_train.csv"          
                             --epochs 200
                             --batch_size 64
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Sex/CNN/Testing/testing_autoencoder.py" target="_blank">Testing AutoEncoder</a>
...
```
python3 testing_autoencoder.py --csv_load_path "/Sex/Data/"                    
                               --category "sex"               
                               --train_csv "sex_train.csv"          
                               --epochs 5
                               --batch_size 64
                               --learning_rate 1e-3
                               --model_load_path "/Sex/CNN/Models/Saved_Models/"
```
- _csv_load_path_: folder path to load the train, validation and test csv files
- _category_: either "sex", "age", "race", "emotion"
- _train_csv_: the train csv file (default = sex_train.csv)
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Sex/CNN/Testing/cnn_classifier.py" target="_blank">AutoEncoder for Classification</a>
...
```
python3 cnn_classifier.py --csv_load_path "/Sex/Data/"                    
                          --category "sex"               
                          --train_csv "sex_train.csv"          
                          --val_csv "sex_val.csv"
                          --test_csv "sex_test.csv"
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Sex/Data%20Processing/pseudo_labeling.py" target="_blank">Pseudo Labeling using Semi-Supervised Learning</a>
...
```
python3 pseudo_labeling_semisupervised.py --csv_load_path "/Sex/Data/"                    
                                          --category "sex"
                                          --model "resnet18"
                                          --cnn_param_file "resnet18_sex.pt"
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Sex/Transformer/Training/training_wav2vec2.py" target="_blank">Training on Wav2Vec 2.0</a>
...
```
python3 training_wav2vec2.py --csv_load_path "/Sex/Data/"                    
                             --category "sex"                             
                             --model_save_name "transformer_sex"
                             --model_save_path "/Sex/Transformer/Models/Saved_Models/"
                             --train_csv "sex_train.csv"          
                             --val_csv "sex_val.csv"
                             --epochs 20
                             --batch_size 4
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Sex/Transformer/Testing/evaluate_wav2vec2.py" target="_blank">Evaluating on Wav2Vec 2.0</a>
...
```
python3 evaluate_wav2vec2.py --csv_load_path "/Sex/Data/"                    
                             --category "sex"               
                             --test_csv "sex_test.csv"          
                             --epochs 20
                             --batch_size 4
                             --learning_rate 3e-5
                             --model_load_path "/Sex/Transformer/Saved_Models/wav2vec2-base-finetuned-ks/checkpoint-835”
                             --model_dir_path "/Sex/Transformer/Saved_Models/"
``` 
