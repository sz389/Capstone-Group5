...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Age/Data%20Processing/generate_mel_spectrogram.py" target="_blank">Generating Mel Spectrograms</a>
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Age/CNN/Training/train_cnn.py" target="_blank">Training CNN</a>
...
- _train_csv_: the train csv file (default = age_train.csv)
- _val_csv_: the validation csv file (default = age_val.csv)
- _test_csv_: the test csv file (default = age_test.csv)
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Age/Data%20Processing/augmentation.py" target="_blank">Augmenting Audio</a>
...
```
python3 augmentation.py --csv_folder "/Age/Data/"                    
                        --save_path "/Age/Data/"               
                        --category "age"      
```
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Age/CNN/Training/train_autoencoder.py" target="_blank">Training AutoEncoder</a>
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Age/CNN/Testing/testing_autoencoder.py" target="_blank">Testing AutoEncoder</a>
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Age/CNN/Testing/cnn_classifier.py" target="_blank">AutoEncoder for Classification</a>
...
```
python3 cnn_classifier.py --csv_load_path "/Age/Data/"                    
                          --category "age"               
                          --train_csv "age_train.csv"          
                          --val_csv "age_val.csv"
                          --test_csv "age_test.csv"
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Age/Data%20Processing/Pseudo%20Labeling/pseudo_labeling_semisupervised.py" target="_blank">Pseudo Labeling using Semi-Supervised Learning</a>
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Age/Transformer/Training/training_wav2vec2.py" target="_blank">Training on Wav2Vec 2.0</a>
...
```
python3 training_wav2vec2.py --csv_load_path "/Age/Data/"                    
                             --category "age"                             
                             --model_save_name "transformer_age"
                             --model_save_path "/Age/Transformer/Models/Saved_Models/"
                             --train_csv "age_train.csv"          
                             --val_csv "age_val.csv"
                             --epochs 20
                             --batch_size 4
...
### <a href="https://github.com/sz389/Capstone-Group5/blob/main/Code/Age/Transformer/Testing/evaluate_wav2vec2.py" target="_blank">Evaluating on Wav2Vec 2.0</a>
...
```
python3 evaluate_wav2vec2.py --csv_load_path "/Age/Data/"                    
                             --category "age"               
                             --test_csv "age_test.csv"          
                             --epochs 20
                             --batch_size 4
                             --learning_rate 3e-5
                             --model_load_path "/Age/Transformer/Saved_Models/wav2vec2-base-finetuned-ks/checkpoint-835”
                             --model_dir_path "/Age/Transformer/Saved_Models/"
``` 
