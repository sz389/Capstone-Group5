...
2. Using the CREMA-D_nopath.csv file along with the AudioWAV folder
3. Using the resulting CSV file with the path, run mel_spectrogram.py to generate Mel Spectrograms inside another folder.
    - 
