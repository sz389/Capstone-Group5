...
def train_supervised(model, train_loader, test_loader):
    ...
    for epoch in tqdm(range(EPOCHS)):
        ...
        if epoch % 10 == 0:
            ...
            print('Epoch: {} : Train Loss : {:.5f} | Test Acc : {:.5f} | Test Loss : {:.3f} '.format(epoch,
                                                                                                     running_loss / (
                                                                                                                 10 * len(
                                                                                                             train)),
                                                                                                     test_acc,
...
torch.save(net.state_dict(), '/home/ubuntu/capstone/CNN/Models/Saved_Models/supervised_weights')
