...
sample_rate = 16000
n_fft = 1024 #[512, 1024, 1536,2048]
win_length = None #Some
hop_length = 256 #[256, 512, 1024]
n_mels = 128 #[96, 128, 160]
...
df1['emotion'] = label2
#%%
df1.to_csv(csv_path+'Mel_Spectrograms_1024_256_128.csv',index=False)
