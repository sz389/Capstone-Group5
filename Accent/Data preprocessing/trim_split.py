...
#%%
    df_train = pd.read_csv(csv_path + 'new_data_train.csv')
    df_test = pd.read_csv(csv_path + 'new_data_test.csv')
    df_val = pd.read_csv(csv_path + 'new_data_val.csv')
    #%%
  ...
  #  filename = get_filename(df1['path'])
